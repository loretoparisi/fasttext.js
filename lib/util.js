...
(function () {
    ...
    var Util = {
        ...
        /**
         * Retrieve binary file by platform
         * @param {*} filename 
         * @returns 
         */
        GetBinFolder: function (filename) {
            ...
            var cpuCore = os.cpus();
            var isIntel = cpuCore[0].model.includes("Intel")
            var isM1 = cpuCore[0].model.includes("Apple")
    
            if (process.platform === 'win32') {
                filename = filename + '.exe';
            } else if (isM1 && !isIntel) { // apple silicon
                platform = 'apple';
            }
            ...
            process.chdir(root);
            var binpath = resolve('.' + path.sep + 'bin' + path.sep + platform + path.sep + filename);
            process.chdir(cdir);
